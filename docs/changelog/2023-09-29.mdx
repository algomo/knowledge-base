...
<h2 id="tools">Organisation working hours</h2>

**_Coming soon..._**

- If a customer gets in touch outside of your office hours, they will be able to see that the organisation may not repond for some time. 
- This sets your customers’ expectations for when they should expect a response and ensures they are not dissapointed by slightly longer wait times.
- The chatbot will be able use the knowledge of your organisations working hours to better select tools:
  - The chatbot may choose not to escalte to a human if the visitor is interacting outside of working hours
